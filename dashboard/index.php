...
Name of Project : <input type=text name="newProj" placeholder="Type Project Name Here..."/>&nbsp;&nbsp;&nbsp;&nbsp;<input type=submit value="Create" style="border: 0px solid #ccc;height: 40px;width: 80px;background-color: #3f729b;color: white; letter-spacing: 0.7px; box-shadow: 0 2px 4px 0 rgba(0,0,0,0.5),0 2px 10px 0 rgba(0,0,0,0.12)!important;"/>
