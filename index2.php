...
<!--		<li class="c-circle-nav__item">
    ...
    <section id="intro" class="intro">
		<div class="slogan">
			<h2 class="slogan">WELCOME TO LOGIC Room</h2>
			<h4>WE ARE MAKING DEVELOPERS TOGETHER</h4>
		</div>
 ...
 <!--                       <p class="subtitle"></p>
	...
	<div class="row">
	<iframe src="https://logicchat.firebaseapp.com/" height="310" width="420px" frameborder="10" style="border-radius:10px;float:left;border:10;" ></iframe><br /><?
	//include("logicchat.firebaseapp.com/index.html");?>
...
<!--				  <abbr title="Phone">Call:</abbr> +91 9033344041<br />-->
				...
				<address><br />
				  ...
				  <h5><a href="mailto:niravpatel1450@gmail.com">niravpatel1450@gmail.com</a>
				  				  <h5><a href="mailto:nirav.madariya@studentpartner.com">nirav.madariya@studentpartner.com</a><br /><br />
<!--				<a href="mailto:jadejadivyarajsinh09@gmail.com">jadejadivyarajsinh09@gmail.com</a></h5>-->
				</address>	
				<address>
				  <!--<strong>We're on social networks</strong><br>
                       	<ul class="company-social">
                            <li class="social-facebook"><a href="http://www.Facebook.com/RoomOnline" target="_blank"><i class="fa fa-facebook"></i></a></li>
                            <li class="social-twitter"><a href="http://www.twitter.com/roomonline" target="_blank"><i class="fa fa-twitter"></i></a></li>
                            <li class="social-dribble"><a href="http://www.plus.google.com/+NiravPatel1450" target="_blank"><i class="fa fa-google-plus"></i></a></li>
